...
class Number extends Component
{
    ...
    public $field='number'; //['id', 'name', 'placeholder', 'value'] ['readonly', 'disabled', 'autocomplete', 'required'] ['class for field']
    ...
    {  
        return view('dataentry::components.elements.data-entry.form.basic-inputs.number');
    }
}