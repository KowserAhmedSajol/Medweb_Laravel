...
class Email extends Component
{
    ...
    public $field='email'; //['id', 'name', 'placeholder', 'value'] ['readonly', 'disabled', 'autocomplete', 'required'] ['class for field']
    public $help = []; //['text' => __('e.g john@gmail.com'), 'class'=>'abc']
    public $icon = []; //['key' =>'icon-envelop2', 'align'=>'left']
    public $decoration = []; // ['class' => '', 'style' => 'inline css']
    ...
    {  
        return view('dataentry::components.elements.data-entry.form.basic-inputs.email');
    }
}