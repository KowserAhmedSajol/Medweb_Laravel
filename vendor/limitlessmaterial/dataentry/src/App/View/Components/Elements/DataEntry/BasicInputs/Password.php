...
class Password extends Component
{
    ...
    public $field='password'; //['id', 'name', 'placeholder', 'value'] ['readonly', 'disabled', 'autocomplete', 'required'] ['class for field']
    ...
    private function _label($labelConfig){
        ...
        if(is_array($labelConfig) && array_key_exists('text',$labelConfig) && !empty($labelConfig['label'])){
    ...
    {
        return view('dataentry::components.elements.data-entry.form.basic-inputs.password');
    }
}