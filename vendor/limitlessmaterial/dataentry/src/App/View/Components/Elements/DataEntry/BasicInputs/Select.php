...
class Select extends Component
{
    ...
    public $field='search'; //['id', 'name', 'placeholder', 'value'] ['readonly', 'disabled', 'autocomplete', 'required'] ['class for field']
    ...
    private function _grid($gridConfig){
        ...
        if(!is_array($gridConfig) && !empty($gridConfig)){
            $this->grid['field'] = 'error: please pass an array';
        }
    ...
    { 
        return view('dataentry::components.elements.data-entry.form.basic-inputs.select');
    }
}