...
class Time extends Component
{
    ...
    public $field='time'; //['id', 'name', 'placeholder', 'value'] ['readonly', 'disabled', 'autocomplete', 'required'] ['class for field']
    ...
    {
        return view('dataentry::components.elements.data-entry.form.basic-inputs.time');
    }
}